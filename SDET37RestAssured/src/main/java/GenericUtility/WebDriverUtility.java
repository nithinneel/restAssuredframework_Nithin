...
public class WebDriverUtility {
	...
	{
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(IConstants.implicitlyWait));
	}
	/**
	...
	{
		driver.manage().timeouts().scriptTimeout(Duration.ofSeconds(IConstants.implicitlyWait));
	}
	/**
	...
	{
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(IConstants.explicitWait));
